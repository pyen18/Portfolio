...
export default function Home() {
  ...
  const [code] = useState(`
const profile = {
    name: 'NGUYEN PHUC YEN',
    title: 'Full-Stack Developer | FRONT-END Developer | Problem Solver',
    skills: [
        'React', 'NextJS', 'Redux', 'Express',
        'MySQL', 'MongoDB', 'Docker', 'TypeScript',
        'GraphQL', 'Git','JIRA', 'Discord Development'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed flex items-center gap-3 flex-wrap">
                  ...
                  <span className="flex items-center gap-2">
                    <img
                      ...
                      alt="NextJS"
                      className="w-6 h-6 sm:w-7 sm:h-7 invert dark:invert-0"
                    />
                    NextJS
                  </span>
                  <span>|</span>
